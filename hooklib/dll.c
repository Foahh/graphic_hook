...
static HMODULE WINAPI hook_LoadLibraryExA(const char *name, HANDLE file,
                                          DWORD flags);
static HMODULE WINAPI hook_LoadLibraryExW(const wchar_t *name, HANDLE file,
                                          DWORD flags);
...
static HMODULE(WINAPI *next_LoadLibraryExA)(const char *name, HANDLE file,
                                            DWORD flags);
static HMODULE(WINAPI *next_LoadLibraryExW)(const wchar_t *name, HANDLE file,
                                            DWORD flags);
...
static void dll_hook_init(void) {
    ...
    hook_table_apply(NULL, "kernel32.dll", dll_loader_syms,
